...
var messages = map[MsgKey]map[Language]string{
	...
	MsgPreviousProcessing: {
		LangEnglish:            "⏳ Previous request still processing. Use `/guide <message>` to guide the running task.",
		LangChinese:            "⏳ 上一个请求仍在处理中。使用 `/guide <消息>` 可向正在执行的任务追加引导信息。",
		LangTraditionalChinese: "⏳ 上一個請求仍在處理中。使用 `/guide <訊息>` 可向正在執行的任務追加引導資訊。",
		LangJapanese:           "⏳ 前のリクエストを処理中です。`/guide <メッセージ>` で実行中のタスクにガイドを送れます。",
		LangSpanish:            "⏳ La solicitud anterior aún se está procesando. Use `/guide <mensaje>` para guiar la tarea en curso.",
	},
	MsgMessageQueued: {
	...
	MsgPsSent: {
		LangEnglish:            "✅ Guidance delivered.",
		LangChinese:            "✅ 引导信息已送达。",
		LangTraditionalChinese: "✅ 引導資訊已送達。",
		LangJapanese:           "✅ ガイドを送信しました。",
		LangSpanish:            "✅ Guía entregada.",
	},
	MsgPsSendFailed: {
		LangEnglish:            "❌ Failed to deliver guidance.",
		LangChinese:            "❌ 引导信息发送失败。",
		LangTraditionalChinese: "❌ 引導資訊傳送失敗。",
		LangJapanese:           "❌ ガイドの送信に失敗しました。",
		LangSpanish:            "❌ Error al entregar la guía.",
	},
	MsgPsEmpty: {
		LangEnglish:            "Usage: `/guide <message>`",
		LangChinese:            "用法：`/guide <消息>`",
		LangTraditionalChinese: "用法：`/guide <訊息>`",
		LangJapanese:           "使い方：`/guide <メッセージ>`",
		LangSpanish:            "Uso: `/guide <mensaje>`",
	},
	MsgPsNoSession: {
	...
	MsgBuiltinCmdPs: {
		LangEnglish:            "Guide the running task",
		LangChinese:            "引导正在执行的任务",
		LangTraditionalChinese: "引導正在執行的任務",
		LangJapanese:           "実行中のタスクをガイド",
		LangSpanish:            "Guiar la tarea en curso",
	},
	MsgDiffEmpty: {
